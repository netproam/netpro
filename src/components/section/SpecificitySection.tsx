...
const SpecificitySection = () => {
  return (
   <section className="w-full  flex p-4  flex-col items-center gap-4  ">
    ...
    <div className="flex flex-col w-full lg:px-2 lg:px-8 gap-8 ">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 text-base font-hind font-light  gap-10 lg:place-items-center ">

        <div className="flex flex-col gap-2  lg:items-center lg:text-center">
                <h4 className="font-semibold text-lg lg:text-2xl font-hind">Qualité
</h4>
                <p className="lg:w-2/3 text-sm font-hind font-light" >{`Formées, réactives et engagées,
