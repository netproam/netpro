  ...
  return (
   <section className="w-full flex p-4  flex-col items-center gap-4  ">
    ...
    <div className="flex flex-col w-full px-2 lg:px-8 gap-8 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 text-base font-hind font-light  gap-10 lg:place-items-center ">
        ...
        <div className="flex flex-col gap-2  lg:items-center lg:text-center">
                ...
                <p className="lg:w-2/3 text-base font-hind font-light" >{`Formées, réactives et engagées,
