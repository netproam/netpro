...
const ServicesSection = () => {
  ...
  return (
   <section className="w-full h-full min-h-screen py-4 lg:py-10 bg-slate-50
...
<div className=" grid grid-cols-2 lg:gap-2  h-full w-full  place-items-center   lg:justify-center
