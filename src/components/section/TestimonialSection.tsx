...
,url:`https://images.pexels.com/photos/3769706/pexels-photo-3769706.jpeg?auto=compress&cs=tinysrgb&w=800`}
  ...
  return (
   <section className=" h-[500px] bg-gradient-to-b pt-10
from-[#F0F9F9] to-[#F0F9F9]  w-screen overflow-hidden
...
<div className=" w-screen pt-8 overflow-x-scroll h-full">
<div className="flex w-fit  lg:py-20 py-10   pl-4 gap-10
