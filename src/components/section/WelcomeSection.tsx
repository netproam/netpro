...
t  flex flex-col lg:gap-4
    ...
    animate={{opacity:[0,1],transition:{delay:isTabletOrMobile? 1 :1,duration: isTabletOrMobile? 3: 2}}}
  ...
  transition={{duration:isTabletOrMobile? 1.75 : 1.5,delay: isTabletOrMobile? 1.25 : 1.5}}
