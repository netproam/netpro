...
<p className="pt-8 text-center lg:text-start ">{`Nous sommes en constante croissance`}</p>
</div>
...
<div className="flex flex-col lg:flex-row gap-6 lg:gap-8 w-full  justify-end">
    ...
    <motion.p className="font-semibold relative   text-5xl hidden lg:flex tracking-tighter w-fit "><motion.span className="relative">{rounded}
    
    
    </motion.span>
    <motion.span className="-inset-y-4 absolute inset-x-20">+</motion.span>
