interface MovingSvgProps {
isSelected:boolean
}
const MovingSvgComponent = ({isSelected}:MovingSvgProps) => {
  return (
...
{fill: isSelected? "url(#gradient)" : "#e2e8f0"
          ...
          d="M30.172,7.924l-3.707-4.652c-0.35-0.439-0.882-0.695-1.443-0.695H5.856c-0.563,0-1.095,0.256-1.444,0.695L0.705,7.924
...
export default MovingSvgComponent